...
public class treas extends Fragment {
    ...
    public static treas newInstance() {
        treas fragment = new treas();
        return fragment;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        logo.setImageDrawable(getResources().getDrawable(R.mipmap.tre));
        title.setText(R.string.treasTitle);
        subtitle.setText(R.string.treasSubtitle);

        desc.setText(R.string.treasDesc);
        ...
        organisers.setText(R.string.treasOrganizers);
