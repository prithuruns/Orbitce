...
public class ProjectDisplay extends Fragment {
    ...
    public static ProjectDisplay newInstance() {
        ProjectDisplay fragment = new ProjectDisplay();
        return fragment;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        logo.setImageDrawable(getResources().getDrawable(R.mipmap.pro));
        title.setText(R.string.pdTitle);
        subtitle.setText(R.string.pdSubtitle);
        desc.setVisibility(View.INVISIBLE);
        prelims.setText(R.string.pdPrelims);
        inter.setVisibility(View.INVISIBLE);
        rules.setText(R.string.pdRules);
        finals.setText(R.string.pdFinal);
        organisers.setText(R.string.pdOrganizers);
    }
