...
public class onlQuz extends Fragment {
    ...
    public static onlQuz newInstance() {
        onlQuz fragment = new onlQuz();
        return fragment;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        logo.setImageDrawable(getResources().getDrawable(R.mipmap.qui));
        title.setText(R.string.onlquzTitle);
        desc.setText(R.string.onlquzDesc);
        ...
        organisers.setText(R.string.onlquzOrganizers);
